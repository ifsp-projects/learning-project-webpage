...
export const MaterialCard: React.FC<MaterialCardProps> = ({ type }) => {
  return (
    <div className="flex w-auto max-w-fit cursor-pointer items-center justify-between gap-4 border-l-2 border-slate-300 px-2 transition-all duration-300 hover:bg-slate-100">
