        ...
        <div className="flex w-full gap-4">
          <div className="relative flex w-full">
            ...
            <input
              ...
              id="search"
              autoComplete="off"
              className="w-full rounded-sm bg-slate-700 bg-opacity-15 px-3 py-2 pl-12 text-base outline-none duration-default focus:border-blue-400 focus:ring-2 focus:ring-blue-400"
            />
          </div>
        </div>
